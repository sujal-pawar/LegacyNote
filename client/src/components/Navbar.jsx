      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              to="/"
              className=" px-3 py-2 rounded-md text-base text-white font-medium flex items-center"
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to="/login"
                  className="px-3 py-2 rounded-md text-base font-medium text-white flex items-center"
                  onClick={() => setIsMenuOpen(false)}
                >
                ...
                <Link
                  to="/register"
                  className="px-3 py-2 rounded-md text-base font-medium bg-primary-color text-white flex items-center"
                  onClick={() => setIsMenuOpen(false)}
                >
