        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="font-bold text-xl text-primary-color flex items-center">
          ...
          <div className="hidden md:flex md:items-center md:ml-6">
            <div className="flex space-x-4">
              <Link
                to="/"
                className="px-3 py-2 rounded-md text-sm font-medium flex items-center hover:bg-gray-100"
              >
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link
                    to="/register"
                    className="px-3 py-2 rounded-md btn btn-primary flex items-center"
                  >
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 flex items-center"
                >
